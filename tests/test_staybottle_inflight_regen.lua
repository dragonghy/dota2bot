...
tests['[domain] the corpus, and what reaches the supply clause'] = function()
    ...
    -- The cross-lever agreement this sentence is really about is preserved: the
    -- sibling (test_stayurn_ally_heal.lua) walks its own prefix and ratchets the
    -- same counter from the same floor, so the two still have to move together.
