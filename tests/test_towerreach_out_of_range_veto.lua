...
local function world(path, opts)
    ...
    -- claim about the stub -- but the drivers below still need a value.
    -- Default to the map origin (the pre-#61 behaviour, now explicit), and let
    -- a specific test override with opts.lane_front as a MUTATION PROBE.
