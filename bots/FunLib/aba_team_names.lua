...
Dota2Teams.defaultPostfix = 'D2B' -- Dota2Bot (this fork); upstream OHA used 'OHA'. The postfix is how a player tells our bots from the real OHA item on the scoreboard.
