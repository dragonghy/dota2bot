...
func main() {
	...
	nextSample := -1.0   // next hero-snapshot game-clock boundary; armed once horn known
	nextBuilding := -1.0 // next building-sample boundary
	nextCreep := -1.0    // next creep-sample boundary
